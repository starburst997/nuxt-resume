...
(async () => {
  ...
  if (githubPat) {
    ...
    console.log(
      `Updating the GitHub resume.json Gist (https://gist.github.com/starburst997/${gistId})...`,
    );
...
async function updateGitHubGist({ pat, gistId, stringifiedResumeJson }) {
  await request.patch({
    url: `https://starburst997:${pat}@api.github.com/gists/${gistId}`,
    json: true,
    body: {
      description: snippetGistDescription,
      files: {
