...
(async () => {
  ...
  if (githubPat) {
    const gistId = '73a013f1bfa7ea95fe7fcba1be59627c';
    console.log(
      `Updating the GitHub resume.json Gist (https://gist.github.com/starburt997/${gistId})...`,
    );
...
const snippetGistDescription =
  'My resume.json: https://jsonresume.org/. This file is automatically generated by the CI pipeline of my Nuxt Résumé project: https://github.com/starburst997/nuxt-resume#resumejson. View a rendered version of this data at https://registry.jsonresume.org/nfriend.';
